...
export function getApiBaseUrl(servicePort: number = 8001) {
    ...
    else if (typeof globalThis !== 'undefined' && 'window' in globalThis && (globalThis as any).window.location && (globalThis as any).window.location.hostname && (globalThis as any).window.location.hostname !== 'localhost') {

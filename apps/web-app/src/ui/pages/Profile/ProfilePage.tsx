        ...
        <div className="bg-alice-blue dark:bg-slate-900 font-display text-slate-800 dark:text-slate-200 min-h-screen flex flex-col antialiased selection:bg-blue-500 selection:text-white transition-colors duration-300">
            ...
            <header className="sticky top-0 z-50 w-full backdrop-blur-xl bg-white/80 dark:bg-slate-900/80 border-b border-slate-200 dark:border-slate-700/30">
                <div className="max-w-5xl mx-auto px-6 h-20 flex items-center justify-between relative">
                    <button
                        onClick={() => navigate(-1)}
                        className="group flex items-center gap-2 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 text-sm font-medium z-10"
                    >
                        <ArrowLeft className="group-hover:-translate-x-1 transition-transform" size={20} />
                        <span>Volver</span>
                    </button>
                    <h1 className="absolute left-1/2 top-1/2 -translate-x-1/2 text-slate-900 dark:text-white text-lg font-bold tracking-widest uppercase">
                        MI PERFIL
                    </h1>
            ...
            <main className="flex-1 w-full max-w-5xl mx-auto px-6 py-10 space-y-8">
                ...
                <section className="w-full">
                    <div className="bg-white dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 rounded-2xl p-8 flex flex-col items-center justify-center relative overflow-hidden group shadow-lg dark:shadow-none">

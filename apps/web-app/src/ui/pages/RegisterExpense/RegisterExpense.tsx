...
export const RegisterExpense = () => {
    ...
    return (
        <div className="bg-alice-blue dark:bg-slate-900 font-display text-slate-800 dark:text-slate-200 min-h-screen flex flex-col antialiased transition-colors duration-300">
            {/* Header */}
            <header className="sticky top-0 z-50 w-full bg-alice-blue/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-sky-200 dark:border-slate-800">
                <div className="max-w-xl mx-auto px-6 h-16 flex items-center justify-between">
                    <button
                        onClick={() => navigate(-1)}
                        className="p-2 -ml-2 text-slate-500 dark:text-slate-400 hover:text-cobalt-blue dark:hover:text-white transition-colors rounded-full hover:bg-sky-100 dark:hover:bg-slate-800"
                    >
                        <ArrowLeft size={24} />
                    </button>
                    ...
                    <button className="text-cobalt-blue dark:text-blue-400 font-medium text-sm">
                        Guardar
                    </button>
                </div>
            </header>
            ...
            {/* Bottom Action */}
            <div className="p-6 pb-8 bg-alice-blue dark:bg-slate-900 sticky bottom-0">
                <button

            ...
            <div className="flex-1 flex flex-col min-w-0 relative pb-20 md:pb-0">
                <PageHeader
                    ...
                    rightSlot={
                        <button
                            ...
                            disabled={loading || !formData.precio || !formData.nombre}
                        >
                            {loading ? '...' : 'Guardar'}
                        </button>
                    }
                ...
                <main className="flex-1 w-full max-w-xl mx-auto px-6 py-6 space-y-8">
                    ...
                    <div className="bg-[var(--bg-card)] rounded-3xl p-5 shadow-xl border border-[var(--border-color)] space-y-5">
                        ...
                        {/* 🚩 MEJORA: Comprador fijo (Sin Select/Combo Box) */}
                        <div className="flex items-center gap-4">
                            <div className="w-11 h-11 rounded-2xl bg-[var(--bg-body)] flex items-center justify-center text-[var(--text-secondary)] border border-[var(--border-color)]">
                                <User size={22} />
                            </div>
                            ...
                            <div className="bg-emerald-500/10 text-emerald-500 text-[8px] font-black px-2 py-1 rounded-md uppercase tracking-tighter border border-emerald-500/20">
                                Admin
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between px-1">
                            ...
                            <span className="text-[10px] font-bold text-[var(--primary)] bg-[var(--primary)]/10 px-3 py-1 rounded-full border border-[var(--primary)]/20 shadow-sm">
                        ...
                        <div className="grid gap-3">
                            {integrantes.map(user => {
                                ...
                                // Extraer iniciales correctamente (si es "Yo (Erick)", sacar la 'E')
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className={cn(
                                            ...
                                            isSelected
                                                ? "bg-[var(--primary)] border-[var(--primary)] shadow-[0_0_10px_var(--primary)]/30"
                    ...
                    <div className="pt-4">
                        <button
                            ...
                            onClick={handleSubmit}
                            disabled={loading || formData.participantes_ids.length === 0}
                        >
                            <Check size={24} />
                            <span className="uppercase tracking-widest text-sm">
                                {loading ? 'Sincronizando...' : 'Confirmar y Guardar'}
                            </span>
                        </button>
                    </div>
                </main>
